...
module.exports = async (done) => {
  ...
  try {
    ...
    await setDerivativeSpecification("CallBTC", [SPECIFICATION_AUTHOR,
      "BTC Call Option",
      "CallBTC",
    ...
    await setDerivativeSpecification("CallETH", [SPECIFICATION_AUTHOR,
      "ETH Call Option",
      "CallETH",
    ...
    await setDerivativeSpecification("BTCx5-USDC", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("ETHx5-USDC", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("InsurBTC", [SPECIFICATION_AUTHOR,
      "Insured BTC",
      "InsurBTC",
      [web3.utils.keccak256(deployConfig["BTC-USD"])],
      [web3.utils.keccak256("ChainlinkIterator")],
    ...
    await setDerivativeSpecification("InsurETH", [SPECIFICATION_AUTHOR,
      "Insured ETH",
      "InsurETH",
      [web3.utils.keccak256(deployConfig["ETH-USD"])],
      [web3.utils.keccak256("ChainlinkIterator")],
    ...
    await setDerivativeSpecification("StabBTC", [SPECIFICATION_AUTHOR,
      "Stable BTC",
      "StabBTC",
      [web3.utils.keccak256(deployConfig["BTC-USD"])],
      [web3.utils.keccak256("ChainlinkIterator")],
    ...
    await setDerivativeSpecification("StabETH", [SPECIFICATION_AUTHOR,
      "Stable ETH",
      "StabETH",
      [web3.utils.keccak256(deployConfig["ETH-USD"])],
      [web3.utils.keccak256("ChainlinkIterator")],
    ...
    await setDerivativeSpecification("InsurLINK", [SPECIFICATION_AUTHOR,
      "Insured LINK",
      "InsurLINK",
    ...
    await setDerivativeSpecification("CallLINK", [SPECIFICATION_AUTHOR,
      "LINK Call Option",
      "CallLINK",
      [web3.utils.keccak256(deployConfig["LINK-USD"])],
      [web3.utils.keccak256("ChainlinkIterator")],
    ...
    await setDerivativeSpecification("EURx5-USDC", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("GBPx5-USDC", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("JPYx5-USDC", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("GOLDx5-USDC", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("N225x5-USDC", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("FTSEx5-USDC", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("SynthGAS", [SPECIFICATION_AUTHOR,
      "Synthetic Gas",
      "SynthGAS",
    ...
    await setDerivativeSpecification("BTCx5-USDT", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("ETHx5-USDT", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("EURx5-USDT", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("GBPx5-USDT", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("JPYx5-USDT", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("GOLDx5-USDT", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("N225x5-USDT", [SPECIFICATION_AUTHOR,
    ...
    await setDerivativeSpecification("FTSEx5-USDT", [SPECIFICATION_AUTHOR,
